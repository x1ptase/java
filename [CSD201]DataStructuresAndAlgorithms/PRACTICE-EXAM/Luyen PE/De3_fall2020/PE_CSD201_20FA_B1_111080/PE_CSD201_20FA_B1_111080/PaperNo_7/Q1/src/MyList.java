...
//==================================================================
    ...
    void f3() throws Exception {
       ...
       to complete the question in the exam paper.*/
        ...
        //tim ra node co maximum type
        Node maximumTypeNode = head;
       
        for (Node currentNode = head; currentNode != null; currentNode = currentNode.next) {
            //neu nhu co phan tu nao co type lon hon maximum => gan gia tri cua no
            // cho maximum
            if (currentNode.info.type > maximumTypeNode.info.type) {
                maximumTypeNode = currentNode;
            }
        }
        
        //tim xem co node thu 2 co gia tri tuong tu (type) voi maximum type 
        int count = 0;
        Node maximumTypeSecond = null;
        for (Node currentNode = head; currentNode != null; currentNode = currentNode.next) {
            //neu nhu co phan tu nao co type lon hon maximum => gan gia tri cua no
            // cho maximum
            if (currentNode.info.type ==  maximumTypeNode.info.type ) {
            ...
            if (count == 2) {
                maximumTypeSecond = currentNode;
                break;
            }
        }
        
        if (maximumTypeSecond != null) {
            remove(maximumTypeSecond);
        }
