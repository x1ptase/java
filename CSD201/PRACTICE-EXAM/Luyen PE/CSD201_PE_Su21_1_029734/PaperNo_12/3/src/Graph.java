...
//=================================================================
    List<String> dijkstra(int fro, int to) {
        String s1 = "", s2 = "";
        ...
        for (i = selecteds.size() - 3; i < selecteds.size(); i++) {
            int index = selecteds.get(i);
            s2 += " " + v[index] + "-" + d[index];
        }
        list.add(s1);
        list.add(s2.trim());
    ...
    void f2() throws Exception {
       ...
       to complete the question in the exam paper.*/
        ...
        List<String> list1 = dijkstra(1, 5);
        List<String> list2 = dijkstra(0, 6);
        f.writeBytes(list1.get(0) + "\r\n");
        f.writeBytes(list2.get(0) + "\r\n");
        f.writeBytes(list2.get(1) + "\r\n");
        //-------------------------------------------------------------------------------------
        f.writeBytes("\r\n");
        f.close();
    }
