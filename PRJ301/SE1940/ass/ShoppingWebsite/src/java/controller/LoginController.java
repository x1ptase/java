...
public class LoginController extends HttpServlet {
    ...
    private static final String USER_CONTROLLER="MainController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(accountDTO != null){
                ...
                session.setAttribute("accountLoggedIn", accountDTO);
                
                if(accountDTO.isType()){
                    url=SEARCH_PAGE; // admin
                } else{
                    url=USER_CONTROLLER + "?action=ViewDetails"; // user
                }  
            } else{
